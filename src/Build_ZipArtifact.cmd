...
set outFile=%artifactsDir%NatCruise.zip

cd %parent%NatCruise.Wpf\bin\Release\net472

call %zip% a -tzip -spf %outFile%  NatCruise.Wpf.exe NatCruise.Wpf.exe.config runtimes\win-x86\native\*.dll runtimes\win-x64\native\*.dll *.dll
