...
namespace FScruiser.XF.Views
{
    ...
    public partial class AskKpiView : DialogPage
    {
        public AskKpiView()
        {
            InitializeComponent();
        ...
        public static AskKPIResult CheckInput(string displayValue, int? minKPI, int? maxKPI, out string errorMessage)
        {
            ...
            {
                errorMessage = null;
                return new AskKPIResult { IsSTM = true, DialogResult = DialogResult.OK };
            }
            else if (int.TryParse(displayValue, out int i_value))
            {
                ...
                {
                    errorMessage = null;
                    return new AskKPIResult { KPI = i_value, DialogResult = DialogResult.OK };
                }
            }
            else
            {
