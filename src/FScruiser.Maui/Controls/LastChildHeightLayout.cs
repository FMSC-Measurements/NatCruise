...
public class LastChildHeightLayout : Layout<View>, IElementConfiguration<LastChildHeightLayout>
{
    ...
    private readonly Lazy<PlatformConfigurationRegistry<LastChildHeightLayout>> _platformConfigurationRegistry;
    ...
    private static void LayoutChildIntoBoundingRegion(View child, Rect region, SizeRequest childSizeRequest)
    {
    ...
    private void CalculateNaiveLayout(LayoutInformation layout, double x, double y, double widthConstraint, double heightConstraint)
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            if (i == lastChildIndex)
            {
                ...
                var bounds = new Rect(x, lastChildyOffset, request.Request.Width, lastChildHeight);
        ...
        layout.Bounds = new Rect(x, y, requestWidth, yOffset - y);
