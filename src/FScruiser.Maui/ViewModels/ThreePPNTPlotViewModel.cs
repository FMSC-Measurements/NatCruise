...
public class ThreePPNTPlotViewModel : ViewModelBase
{
    ...
    public ICommand AddPlotCommand => _addPlotCommand ??= new RelayCommand(() => AddPlotAsync().FireAndForget());

    public ICommand CancelCommand => _cancelCommand ??= new RelayCommand(() => Cancel().FireAndForget());

    protected ICruiseNavigationService NavigationService { get; }
    protected ISampleGroupDataservice SampleGroupDataservice { get; }
    protected Random Random { get; }
    protected IPlotStratumDataservice PlotStratumDataservice { get; }
